...
public class CroupierSample<C extends Object> implements CroupierMsg.OneWay {
    ...
    public final Set<Container<NattedAddress, C>> publicSample;
    public final Set<Container<NattedAddress, C>> privateSample;
    
    public CroupierSample(int overlayId, Set<Container<NattedAddress, C>> publicSample, Set<Container<NattedAddress, C>> privateSample) {
