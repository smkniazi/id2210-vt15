 ...
 */
public class BasicNattedAddress implements NattedAddress {
    private final BasicAddress base;
    private final NatType natType;
    private final Set<NattedAddress> parents;
    
    public BasicNattedAddress(BasicAddress base, NatType natType, Set<NattedAddress> parents) {
        this.base = base;
        this.natType = natType;
        this.parents = parents;
    }
    
    public BasicNattedAddress(BasicAddress base) {
        this(base, NatType.OPEN, new HashSet<NattedAddress>());
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BasicNattedAddress other = (BasicNattedAddress) obj;
    ...
    @Override
    public Set<NattedAddress> getParents() {
        return parents;
    }
